...
define(["require", "exports", './Option'], function (require, exports, Option_1) {
    var ThemeSelector = (function (_super) {
        ...
        ThemeSelector.prototype.Draw = function (ctx, units, i, panel, yoveride) {
        ...
        ThemeSelector.prototype.DrawDiamond = function (ctx, x, y) {
            var grd = App.GridSize * 0.5;
            ctx.beginPath();
            ctx.moveTo(x, y - grd);
            ctx.lineTo(x - grd, y);
...
//# sourceMappingURL=OptionColorTheme.js.map