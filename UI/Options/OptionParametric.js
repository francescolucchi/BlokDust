...
define(["require", "exports", './Option'], function (require, exports, Option_1) {
    ...
    var Parametric = (function (_super) {
        __extends(Parametric, _super);
        function Parametric(position, size, name, handle0, handle1, handle2, handle3) {
            _super.call(this);
        ...
        Parametric.prototype.Draw = function (ctx, units, i, panel) {
            ...
            for (var j = 0; j < 4; j++) {
                ...
                var size = 2 * units;
                if (j == 0 || j == 3) {
                    App.FillColor(ctx, App.Palette[3 + j]);
                    ctx.beginPath();
        ...
        Parametric.prototype.PlotGraph = function () {
        ...
        Parametric.prototype.CurvePass = function (type, freq, q, gain) {
            var tempGain = [];
            // BELL CURVE //
            for (var h = 0; h < (this.Smoothness); h++) {
        ...
        Parametric.prototype.Bell = function (t, b, c, d) {
            return c * Math.exp(-(t * t) / Math.pow((d * 0.5), 2)) + b;
        };
        Parametric.prototype.logPosition = function (minpos, maxpos, minval, maxval, value) {
        ...
        Parametric.prototype.linValue = function (minpos, maxpos, minval, maxval, position) {
...
//# sourceMappingURL=OptionParametric.js.map