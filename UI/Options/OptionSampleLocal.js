...
define(["require", "exports", './Option'], function (require, exports, Option_1) {
    var OptionSampleLocal = (function (_super) {
        __extends(OptionSampleLocal, _super);
        function OptionSampleLocal(position, size, name, track, setting) {
            _super.call(this);
        ...
        OptionSampleLocal.prototype.Draw = function (ctx, units, i, panel) {
        ...
        return OptionSampleLocal;
    })(Option_1.Option);
    exports.OptionSampleLocal = OptionSampleLocal;
});
//# sourceMappingURL=OptionSampleLocal.js.map