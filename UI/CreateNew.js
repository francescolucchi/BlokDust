...
define(["require", "exports"], function (require, exports) {
    ...
    var CreateNew = (function (_super) {
        __extends(CreateNew, _super);
        function CreateNew() {
            _super.apply(this, arguments);
            this._RollOvers = [];
        }
        CreateNew.prototype.Init = function (drawTo) {
        ...
        CreateNew.prototype.CheckState = function () {
        ...
        //  DRAW
        //-------------------------------------------------------------------------------------------
        CreateNew.prototype.Draw = function () {
            var ctx = this.Ctx;
            var units = App.Unit;
        ...
        //  TWEEN
        //-------------------------------------------------------------------------------------------
        CreateNew.prototype.DelayTo = function (panel, destination, t, delay, v) {
        ...
        CreateNew.prototype.StopAllTweens = function () {
        ...
        //  INTERACTION
        //-------------------------------------------------------------------------------------------
        CreateNew.prototype.OpenPanel = function () {
            this.Open = true;
        ...
        CreateNew.prototype.ClosePanel = function () {
            this.Open = false;
            this.DelayTo(this, 0, 0.3, 0, "Selected");
            this.DelayTo(this.PanelOffset, -1, 0.3, 0, "y");
            this.DelayTo(App.MainScene.Header, 30, 0.3, 0, "CreateNewMargin");
        };
        CreateNew.prototype.ShowMessage = function () {
            this.PanelOffset2.y = 0;
        };
        CreateNew.prototype.CloseMessage = function () {
            this.DelayTo(this.PanelOffset2, 1, 0.6, 0, "y");
        };
        CreateNew.prototype.MouseDown = function (point) {
            this.HitTests(point);
            // ICON //
            if (this._RollOvers[0]) {
                this.OpenPanel();
        ...
        CreateNew.prototype.MouseUp = function (point) {
        };
        CreateNew.prototype.MouseMove = function (point) {
            this.HitTests(point);
        };
        CreateNew.prototype.HitTests = function (point) {
            this.Hover = false;
            var ctx = this.Ctx;
            var units = App.Unit;
            var xOffset = this.IconOffset.x * ((this.IconPos.x * units) * 2);
        ...
        CreateNew.prototype.CreateNewScene = function () {
            this.BlockCount = 0;
