define(["require", "exports"], function (require, exports) {
    ...
    var MenuItem = (function () {
        function MenuItem(position, size, name, id, description, sketch) {
        ...
        MenuItem.prototype.Draw = function (displayContext, units, x, y) {
        ...
        MenuItem.prototype.PrintAtWordWrap = function (context, text, x, y, lineHeight, fitWidth) {
            fitWidth = fitWidth || 0;
            if (fitWidth <= 0) {
        ...
        MenuItem.prototype.MouseDown = function (point) {
            this.MouseIsDown = true;
            this.MousePoint = new Point(point.x, point.y);
        };
        MenuItem.prototype.MouseMove = function (point, header, cutoff) {
        ...
        MenuItem.prototype.MouseUp = function () {
            this.MouseIsDown = false;
        };
        return MenuItem;
    })();
