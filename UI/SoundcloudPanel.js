...
define(["require", "exports", '../Device'], function (require, exports, Device_1) {
    var Dimensions = Utils.Measurements.Dimensions;
    var DisplayObject = etch.drawing.DisplayObject;
    var SoundcloudPanel = (function (_super) {
        __extends(SoundcloudPanel, _super);
        function SoundcloudPanel() {
            _super.apply(this, arguments);
            this._Page = 1;
            this._ItemNo = 5;
            this._Blink = 0;
        }
        SoundcloudPanel.prototype.Init = function (drawTo) {
            var _this = this;
            ...
            // DOM ELEMENTS //
            this.SearchInputContainer = document.getElementById("soundCloudSearch");
            this.SearchInput = document.getElementById("soundCloudSearchInput");
            this.SearchInput.addEventListener('input', function (event) {
                _this.TestString(_this.SearchInput);
                _this.UpdateString(_this.SearchInput);
            });
        ...
        SoundcloudPanel.prototype.TestString = function (element) {
        ...
        SoundcloudPanel.prototype.UpdateString = function (element) {
            var string = element.value;
            this.SearchString = string;
        };
        // SET A PROVIDED DOM ELEMENT'S STRING //
        SoundcloudPanel.prototype.UpdateFormText = function (element, str) {
            element.value = str;
        };
        // ENTER PRESSED ON INPUT //
        SoundcloudPanel.prototype.EnterCheck = function (e) {
            var key = e.which || e.keyCode;
            if (key === 13) {
                this.Submit();
            }
        };
        SoundcloudPanel.prototype.Submit = function () {
        ...
        //  DRAW
        //-------------------------------------------------------------------------------------------
        SoundcloudPanel.prototype.Draw = function () {
            var ctx = this.Ctx;
            ...
            if (this.Open) {
                ...
                for (var i = 0; i < results; i++) {
                    ...
                    if (p > (this._Page - 3) && p < (this._Page + 1)) {
                        // divider //
                        if (n < 4 && i < (results - 1)) {
                            ctx.beginPath();
        ...
        SoundcloudPanel.prototype.WordWrap = function (context, text, x, y, lineHeight, fitWidth) {
            fitWidth = fitWidth || 0;
            if (fitWidth <= 0) {
        ...
        //  TWEEN
        //-------------------------------------------------------------------------------------------
        SoundcloudPanel.prototype.DelayTo = function (panel, destination, t, delay, v) {
        ...
        //  INTERACTION
        //-------------------------------------------------------------------------------------------
        SoundcloudPanel.prototype.OpenPanel = function () {
        ...
        SoundcloudPanel.prototype.MouseUp = function (point) {
        };
        SoundcloudPanel.prototype.MouseMove = function (point) {
            this.HitTests(point);
        };
        SoundcloudPanel.prototype.HitTests = function (point) {
            var units = App.Unit;
        ...
        SoundcloudPanel.prototype.Resize = function () {
            this.OffsetX = -((this._Page - 1) * (430 * App.Unit));
            this.ClearScroll();
            if (this.SearchInput) {
        ...
        SoundcloudPanel.prototype.RandomSearch = function (block) {
        ...
        //  CSS / DOM
        //-------------------------------------------------------------------------------------------
        SoundcloudPanel.prototype.TweenDom = function (element, value, mode, position, offset) {
            var units = (App.Unit);
        ...
        SoundcloudPanel.prototype.StyleDom = function (element, width, height, x, y, xOffset, font) {
            var units = (App.Unit);
            var pr = App.Metrics.PixelRatio;
        ...
        SoundcloudPanel.prototype.ShowDom = function () {
            var search = this.SearchInputContainer;
            search.style.display = "block";
            search.style.visibility = "true";
        };
        SoundcloudPanel.prototype.HideDom = function () {
            var search = this.SearchInputContainer;
            search.style.display = "none";
            search.style.visibility = "false";
        };
        SoundcloudPanel.prototype.ClearScroll = function () {
            window.scrollTo(0, 0);
        };
        return SoundcloudPanel;
    })(DisplayObject);
    exports.SoundcloudPanel = SoundcloudPanel;
});
//# sourceMappingURL=SoundcloudPanel.js.map